...
//        }
    	...
    	// crear service con factories
    	InvoicingService is = Factories.service.forCreateInvoiceService();
    	
    	//facoties.accion a realizar
    	
    	InvoiceDto invoicesCreated = is.create(workOrderIds);
    	//sacar resulatdos en pantalla si es necesario 
		System.out.println(invoicesCreated.toString());
